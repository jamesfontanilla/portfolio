...
export function MobileHomeScreen({ onOpenApp }: MobileHomeScreenProps) {
  ...
  return (
    ...
    >
      ...
      {/* Location badge */}
      {settings?.location && (
        <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginTop: '16px', padding: '6px 12px', borderRadius: '999px', background: 'rgba(28,28,28,0.45)', border: '1px solid rgba(255,255,255,0.06)' }}>
